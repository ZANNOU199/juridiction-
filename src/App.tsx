           ...
           winner ? (
            ...
            <div className="space-y-0 md:space-y-1 flex flex-col min-w-0">
              <div className="flex justify-end gap-0.5 md:gap-1 items-end flex-1">
                <div className="w-[9rem] h-[6.375rem] sm:w-[19rem] sm:h-[11.5rem] md:w-[24rem] md:h-[18rem] bg-white/5 border border-white/10 flex items-center justify-center p-0.5 relative group overflow-hidden shrink-0">
                  <DancerPhoto
                    photoUrl={redP?.photo}
                    alt={redP?.name}
